  ...
  <div>
    <UTable :rows="rows" :columns="columns" v-model:sort="sort"
      ...
      <template #rating-data="{row}">
        <div :class="{ 'bg-red-500/40': row.rating < 4.5, 'bg-green-500/40': row.rating >= 4.5 }" class="px-12 flex justify-center py-12">
          {{ row.rating }}
        </div>
      </template>
    </UTable>
    ...
    <div class="px-3 py-3.5 border-b border-gray-200 dark:border-gray-700 flex justify-center">
